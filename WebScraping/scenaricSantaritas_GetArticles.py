...
from Classes.scenicSantaritasArticleInformation import ScenicSantaritasArticleInformation
...
links = open('scenicSantaritas_ArticleLinks.txt').read()
...
with webDriver as driver:
    ...
    for eachURL in listOfLinks:
        ...
        try:
            ...
            # Organization
            organization = 'Scenic Santaritas'
            ...
            putThingsInClass = ScenicSantaritasArticleInformation(headline, organization, date, url, text)
...
beginningFilePath = '/Users/yanisa/GoogleDrive/Data_Research/RA_Fall2020_UAlabama/scrapedArticles/scenicSantaritas/'
