...
url = 'http://www.savebristolbay.org/bloghost'
with webDriver as driver:
    ...
    while True:
        ...
        allURLs = soup.find_all('a', attrs={'class': 'u-url'})
        try:
        ...
        try:
            olderPostsButton = driver.find_element_by_class_name('next-label')
...
fileToWrite = open('saveBristolBay_ArticleLinks.txt', 'w')
for eachLink in finalListOfArticleURLs:
    # write each link to a new line
    fileToWrite.write('http://www.savebristolbay.org')
