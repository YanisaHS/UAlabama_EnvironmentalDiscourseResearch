...
url = 'https://www.scenicsantaritas.org/news/'
with webDriver as driver:
    ...
    while True:
        ...
        allURLs = soup.find_all('a', attrs={'class': 'entry-title-link'})
        try:
        ...
        try:
            olderPostsButton = driver.find_element_by_class_name('pagination-next')
...
fileToWrite = open('scenicSantaritas_ArticleLinks.txt', 'w')
