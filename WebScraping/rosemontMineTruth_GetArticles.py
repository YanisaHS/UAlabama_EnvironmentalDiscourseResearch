...
from Classes.rosemontMineTruthArticleInformation import RosemontMineTruthArticleInformation
...
links = open('rosemontMineTruth_ArticleLinks.txt').read()
...
with webDriver as driver:
    ...
    for eachURL in listOfLinks:
        ...
        try:
            ...
            # Organization
            organization = 'Rosemont Mine Truth'

            # Date
            inProcessDate = soup.find('span', attrs={'class': 'entry-date'})
            ...
            putThingsInClass = RosemontMineTruthArticleInformation(headline, organization, date, url, text)
...
beginningFilePath = '/Users/yanisa/GoogleDrive/Data_Research/RA_Fall2020_UAlabama/scrapedArticles/rosemontMineTruth/'
