...
url = 'http://www.rosemontminetruth.com/'
with webDriver as driver:
    ...
    while True:
        ...
        allURLs = soup.find_all('h2', attrs={'class': 'entry-title'})
        try:
        ...
        try:
            olderPostsButton = soup.find('div', attrs={'class': 'nav-previous'})
            ...
            driver.get(olderPostsButtonPageURL)
        except:
            break

# Write list of links to a file:
fileToWrite = open('rosemontMineTruth_ArticleLinks.txt', 'w')
